...
public class PlayerData {
    ...
    public static void save(FileHandler fileHandler) {
        ...
        fileHandler.save(currentUser + "_player_last_login_date", lastLoginDate);
    ...
    public static void load(FileHandler fileHandler) {
        ...
        String loadedLastLoginDate = fileHandler.retrieveString(currentUser + "_player_last_login_date");
